...
// Fetch triceps exercises from the database
$category = 'triceps';  
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['exercise_image']) && $_FILES['exercise_image']['error'] == 0) {
        ...
        $videoUploadDir = 'C:\\xampp\\htdocs\\sendtoal\\FitZone-Gym\\Videos\\triceps';  // Updated directory for videos
    ...
    if ($stmt) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: triceps-exercises.php"); // Replace with your exercises page URL
            exit;
        } else {
            echo "Error executing query: " . $stmt->error;
        }
            ...
            <div class="content container-fluid">
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Triceps Exercises</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="targeted-exercise.php">Muscle Group</a></li>
                                <li class="breadcrumb-item active">Triceps Exercises</li>
                            </ul>
                        </div>
                ...
                <!-- Table displaying triceps exercises -->
                <div class="panel-body">
                    ...
                    ?>
                          ...
                          <?php
                                    ...
                                    echo '<tr><td colspan="5">No exercises found for triceps.</td></tr>';
                             }
                                ?>
                            </tbody>
                        </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addExerciseModalLabel">Add New Triceps Exercise</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>  
            </div>
            <form id="addExerciseForm" action="triceps-exercises.php" method="POST" enctype="multipart/form-data">
...
function openViewModal(name, description, mediaPath) {
    ...
    document.getElementById('viewMuscleCategory').value = 'triceps'; // Fixed muscle category
...
<div class="modal fade" id="editExerciseModal" tabindex="-1" aria-labelledby="editExerciseModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editExerciseModalLabel">Edit Triceps Exercise</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editExerciseForm" action="update-exercise3.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
