                                        ...
                                        <td>
                                            <div class="dropdown action-label">
                                                <a href="#" class="btn btn-white btn-sm btn-rounded dropdown-toggle"
                                                    ...
                                                    <span
                                                        id="status-text-<?php echo $row['method_id']; ?>"><?php echo ucfirst($status); ?></span>
                                                </a>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        data-bs-target="#edit_method"><i class="fa fa-pencil m-r-5"></i>
                                                        Edit</a>
                                                </div>
                                            </div>
                                        </td>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="store-payment-method.php" method="POST">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label">Payment Method Name <span
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label">Payment Method Type <span
                                                    class="text-danger">*</span></label>
