  ...
  <div class="main-wrapper">
    ...
    <div class="page-wrapper">
                          ...
                          <div class="dropdown dropdown-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <a class="dropdown-item" href="#"
                                onclick="restoreInstructor(<?php echo $row['instructor_id']; ?>)"><i
                                  class="fa fa-undo m-r-5"></i> Restore</a>
                              <a class="dropdown-item" href="#"
                                onclick="deleteInstructor(<?php echo $row['instructor_id']; ?>)"><i
                                  class="fa fa-trash m-r-5"></i> Permanently Delete</a>
                            </div>
                          </div>
                        </td>
                      </tr>
      ...
      <div class="modal fade" id="restoreConfirmationModal" tabindex="-1"
        aria-labelledby="restoreConfirmationModalLabel" aria-hidden="true">
  ...
  <script>
    ...
    document.getElementById('confirmRestoreBtn').addEventListener('click', function () {
      if (selectedInstructorId) {
        ...
        xhr.open("POST", "backend-add-authenticate/restore-archive-instructor.php", true);
