...
<?php }
if ($page == 'offered-programs.php' || $page == 'sales-reports.php' || $page == 'stock-in.php' || $page == 'inventory-reports.php' || $page == 'stock-out.php' || $page == 'product-list.php' || $page == 'categorie.php' || $page == 'product.php' || $page == 'events.php' || $page == 'employees.php' || $page == 'employees-list.php') { ?>
  <!-- Calendar JS -->
