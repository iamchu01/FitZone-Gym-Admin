  ...
  var oe = Mt.extend({
    ...
    update: function (t) {
      var e,
        ...
        u = r.data;
      for (
        a._updateRadius(), r.count = a.countVisibleElements(), e = 0, i = o.data.length;
        e < i;
        e++
      )
    ...
    (ut.where = function (t, e) {
      ...
      (ut.splineCurveMonotone = function (t) {
        ...
        for (e = 0; e < h; ++e)
          if (!(n = u[e]).model.skip) {
            if (
              ((i = e > 0 ? u[e - 1] : null), (a = e < h - 1 ? u[e + 1] : null) && !a.model.skip)
            ) {
    ...
    ai.helpers.each(
      ...
      function (t) {
        ai[t] = function (e, i) {
          return new ai(
            e,
            ai.helpers.merge(i || {}, { type: t.charAt(0).toLowerCase() + t.slice(1) })
          );
        };
      }
    ),
