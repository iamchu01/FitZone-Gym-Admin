!(function (t, e) {
  if ("object" == typeof exports && "object" == typeof module)
    ...
    var n =
      "object" == typeof exports ? e(require("jquery"), require("moment")) : e(t.jQuery, t.moment);
  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      function A(t, n) {
        ...
        for (
          r = 0;
          r < e.unitsDesc.length && ((i = e.unitsDesc[r]), !((o = G(i, t, n)) >= 1 && ut(o)));
          r++
        );
        return i;
      }
    ...
    function (t, e, n) {
      function r(t, e, n) {
        ...
        var i = a.datepicker;
        i &&
          ((i.regional[e] = i.regional[t] = n), (i.regional.en = i.regional[""]), i.setDefaults(n));
      }
      function i(t, e) {
        var n, r;
        (n = p[t] || (p[t] = {})),
          ...
          return (
            ...
            (e.prototype.bindDateHandlerToEl = function (t, e, n) {
              ...
              this.el.on(e, function (t) {
                if (
                  !i(t.target).is(r.segSelector + "," + r.segSelector + " *,.fc-more,a[data-goto]")
                )
                  return n.call(r, t);
              });
            }),
            ...
            (e.prototype.renderHeadDateCellHtml = function (t, e, n) {
              ...
              return (
                ...
                '<th class="' +
                  a.join(" ") +
                  '"' +
                  (1 === (s && r.rowCnt) ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") +
                  (e > 1 ? ' colspan="' + e + '"' : "") +
                  (n ? " " + n : "") +
                  ">" +
                  (s
            ...
            (e.prototype.renderNumberCellHtml = function (t) {
              ...
              return s || this.cellWeekNumbersVisible
                ? ((e = this.getDayClasses(t)),
                  ...
                  s && (i += r.buildGotoAnchorHtml(t, { class: "fc-day-number" }, t.date())),
                  (i += "</td>"))
                : "<td/>";
            }),
          ...
          return (
            this.each(function (i, o) {
              ...
              "string" == typeof t
                ...
                : d || ((d = new a.default(u, t)), u.data("fullCalendar", d), d.render());
            }),
            n
          );
        });
                      ...
                      "title" == s
                        ...
                        : ((l = d[s])
                          ...
                          g &&
                            ...
                            (w = r(
                              '<button type="button" class="' + b.join(" ") + '">' + m + "</button>"
                            )
                              .click(function (t) {
    ...
    function (t, e, n) {
      ...
      (o.list = {
        ...
        (o.listDay = { type: "list", duration: { days: 1 }, defaults: { listDayFormat: "dddd" } }),
        (o.listWeek = {
          type: "list",
          duration: { weeks: 1 },
