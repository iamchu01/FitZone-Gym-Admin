                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item"
                                                        href="plan-details.php?id=<?php echo $row['plan_id']; ?>"><i
                                                            class="fa fa-eye m-r-5"></i> View Details</a>
                                                    <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                        data-bs-target="#edit_plan"><i class="fa fa-pencil m-r-5"></i>
                                                        Edit</a>
                                                </div>
                                            </div>
                                        </td>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="store-membership-plan.php" method="POST">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label">Membership Plan Name <span
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label">Membership Plan Type <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="col-form-label">Duration (in days) <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <!-- Dropdown Trigger -->
                                            <div class="dropdown">
                                                <button class="btn btn-secondary w-100 text-start" type="button"
                                                    id="paymentSelectorButton" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                                    ...
                                                    <li>
                                                        <div class="form-check ms-3">
                                                            ...
                                                            <label class="form-check-label"
                                                                for="selectAll"><strong>Select All</strong></label>
                                                        </div>
                                                    </li>
                                                    <li>
